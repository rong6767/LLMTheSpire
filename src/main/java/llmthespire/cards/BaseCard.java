package llmthespire.cards;

import basemod.BaseMod;
import basemod.abstracts.CustomCard;
import basemod.abstracts.DynamicVariable;
import llmthespire.BasicMod;
import llmthespire.util.CardStats;
import llmthespire.util.TriFunction;
...
import static llmthespire.util.GeneralUtils.removePrefix;
import static llmthespire.util.TextureLoader.getCardTextureString;
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    BasicMod.getLogger().error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
